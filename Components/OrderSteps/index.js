...
import CartStep from "../Stepper/CartStep";
import ShippingStep from "../Stepper/ShippingStep";
import DeliveryStep from "../Stepper/DeliveryStep";
...
const OrderSteps = ({ carts, address, userId }) => {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return {
          component: <CartStep data={carts} />,
          buttonText: "Continue to Shipping",
        };
      case 2:
        return {
          component: <ShippingStep data={address} userId={userId} />,
          buttonText: "Continue to Delivery Info",
        };
      case 3:
        return {
          component: <DeliveryStep data={carts}/>,
